...
const Banner = () => {
  return (
    <div className="py-16 mx-10 lg:mx-35 flex flex-col items-center gap-5 bg-linear-to-b from-[#ebebeb] to-white rounded-3xl border-3 border-white">
      <h1 className="px-5 text-center font-primary font-extrabold text-[25px] lg:text-[40px]">
        Dependable Care, Backed by Trusted Professionals.
      </h1>
      <p className="px-5 sm:p-0 sm:w-100 md:w-150 lg:w-175 font-primary text-[12px] lg:text-[16px] font-medium opacity-80 text-center">
