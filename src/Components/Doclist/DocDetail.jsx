    ...
    return (
        <div className='my-5 mx-13 lg:mx-22.5 flex flex-col gap-5'>
            <div className='bg-white rounded-3xl py-12.5 px-4 sm:px-25 flex flex-col gap-3 items-center'>
                <h1 className='text-center font-primary font-extrabold text-[22px] sm:text-[25px] md:text-[32px]'>Doctor's Profile Details</h1>
                <p className='text-center text-[12px] sm:text-[18px] font-primary font-medium opacity-60'>Lorem ipsum dolor sit amet consectetur. Sit enim blandit orci tortor amet ut. Suscipit sed est fermentum magna. Quis vitae tempus facilisis turpis imperdiet mattis donec dignissim volutpat.</p>
            </div>
            <div className='bg-white rounded-3xl py-12.5 px-4 sm:px-25 flex flex-col gap-4 lg:flex-row items-center'>
                ...
                <div className='md:w-[70%]'>
                    <h1 className='text-center lg:text-left font-primary font-extrabold text-[20px] sm:text-[28px]'>{name}</h1>
                    <p className='text-center lg:text-left font-primary font-medium text-[14px] sm:text-[18px] opacity-60'>{education}</p>
                    <p className='text-center lg:text-left font-primary font-medium text-[14px] sm:text-[18px] opacity-60'>{speciality}</p>
                    <p className='text-center lg:text-left font-primary font-medium text-[14px] sm:text-[18px] opacity-60'>Working at</p>
                    <p className='text-center lg:text-left font-primary font-bold text-[14px] sm:text-[18px]'>{workPlace}</p>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='text-center lg:text-left font-primary font-bold'>Consultation Fee: <span className='text-blue-600'>Taka</span> {fee} <span className='opacity-40'>(incl. Vat)</span> <span className='text-blue-600'>Per consultation</span></p>
                    </div>
                </div>
            </div>
